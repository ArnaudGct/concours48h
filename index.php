        ...
        <!-- <section class="section-infos_concours_index" id="infos_concours_index">
            ...
            <div class="flex-infos_concours_index">
                <div class="compteur-infos_concours_index">
                    <p><span style="font-weight: 600;">L'édition 2024 est terminé !</span></p>
                </div>
                <div class="text-contraintes-infos_concours_index">
                    <p>Merci à toutes les équipes pour ces six courts-métrages réalisés en seulement 48 heures, disponibles sur <a href="./les_editions.php">ce site web</a>.<br>Vous pouvez être fiers de vous ! Rendez-vous l'année prochaine pour une nouvelle édition 🎥.</p>
                </div>
            </div>
        </section> -->
                    ...
                    <div class="container-avantages_concours_index">
                        <div class="item-avantages_concours_index">
                            ...
                            <div class="content_item-avantages_concours_index">
                                <p>Vous devez collaborer en équipe afin de rendre un travail qualitatif en très peu de
                                    temps.</p>
                            </div>
                        </div>
                        <div class="item-avantages_concours_index">
                            ...
                            <div class="content_item-avantages_concours_index">
                                <p>Vous en apprenez d’avantage sur les autres et vous allez sûrement apprendre des
                                    techniques que ce soit niveau montage, cadrage, écriture...</p>
                            </div>
                        </div>
                        <div class="item-avantages_concours_index">
                            <div class="title_item-avantages_concours_index">
                            ...
                            <div class="content_item-avantages_concours_index">
                                <p>À la fin, vous serez fier de vous et de votre équipe pour le travail que vous avez
                                    réalisé. De plus, cette expérience valorisante peut être ajoutée à votre portfolio
                                    professionnel, mettant en avant vos compétences et réalisations.</p>
                            </div>
                        </div>
                        <div class="item-avantages_concours_index">
                            <div class="title_item-avantages_concours_index">
            ...
            <div class="flex-derniere_edition_concours_index">
                <div class="flex_content-derniere_edition_concours_index">
                    ...
                    <div class="description-derniere_edition_concours_index">
                        <p>En 2024, <span>6 équipes</span> ont participé au concours 48h sur le week-end du <span>19 au
                                21 janvier</span>.</p>
                        <ul>
                            <li><span>Merci à l’équipe enseignante</span> qui a permis d’assurer une excellente
                                organisation dans la gestion du matériel.</li>
                            <li><span>Merci aux différents membres du jury</span> qui ont pris le temps de regarder le
                                court-métrage pour la remise du prix du jury.</li>
                            <li><span>Merci aux étudiants</span> qui ont voté pour le prix du public.</li>
                        </ul>
                    </div>
                                ...
                                <div class="content_winner-derniere_edition_concours_index">
                                    ...
                                    <div class="description_winner-derniere_edition_concours_index">
                                        ...
                                        <div class="description_item_winner-derniere_edition_concours_index">
                                            ...
                                            <p>Lauréat du prix du public</p>
                                        </div>
                                    </div>
                                </div>

                                <div class="team_winner-derniere_edition_concours_index">
                                    <p><span>Crédits : </span>Louis Meurice, Arsene Vacher, Alexis Perigaud, Jasmine
