...
<body>
    ...
    <main class="main_all">
        ...
        <section class="participation_section-participer">
            <div class="flex-participer">
                <div class="title_form-participer">
                    <h1>Fin des inscriptions</h1>
                    <p>Rendez-vous le jeudi 25 janvier à 12h30 à l'amphi MMI pour assister à la projection des courts-métrages et voter pour le prix du public.</p>
                </div>
            </div>     
         </section>
